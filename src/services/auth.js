...
const authService = {
  ...
  login: async (email, password, isFromGoogle) => {
    ...
    const { _id, lastLoginAs, isFirstLogin, isRegistrationCompleted, isEmailConfirmed, firstName, lastName, photo } = user

    const tokens = tokenService.generateTokens({ id: _id, role: lastLoginAs, isFirstLogin, isRegistrationCompleted, firstName, lastName, email, photo })
  ...
  refreshAccessToken: async (refreshToken) => {
    ...
    const { _id, lastLoginAs, isFirstLogin, isRegistrationCompleted, firstName, lastName, email, photo } = user
